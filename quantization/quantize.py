...
from .quant_ops import MovingAvgQuantize, LastValueQuantize
# from learners.uniform_quantization_tf import quant_ops
...
_ACTIVATION_TYPES = {'Relu', 'Relu6', 'Identity', 'LeakyRelu'}
