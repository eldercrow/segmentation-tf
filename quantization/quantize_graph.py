...
from .fold_batch_norms import FoldBatchNorms
...
def _create_graph(input_graph=None,
  ...
  if is_bn_training is None:
    is_bn_training = is_training
...
def create_training_graph(input_graph=None, quant_delay=0, is_bn_training=None):
